...
type Log struct {
	...
	Time     *int64         `protobuf:"varint,1,req,name=time" json:"time,omitempty"`        // 时间戳，UNIX时间格式
	Contents []*Log_Content `protobuf:"bytes,2,rep,name=contents" json:"contents,omitempty"` // 一条日志里的多个kv组合
}
...
type LogGroup struct {
	...
	Logs        []*Log    `protobuf:"bytes,1,rep,name=logs" json:"logs,omitempty"`               // 多条日志合成的日志数组
	ContextFlow *string   `protobuf:"bytes,2,opt,name=contextFlow" json:"contextFlow,omitempty"` // 目前暂无效用
	Filename    *string   `protobuf:"bytes,3,opt,name=filename" json:"filename,omitempty"`       // 日志文件名
	Source      *string   `protobuf:"bytes,4,opt,name=source" json:"source,omitempty"`           // 日志来源，一般使用机器IP
...
type LogGroupList struct {
	...
	LogGroupList []*LogGroup `protobuf:"bytes,1,rep,name=logGroupList" json:"logGroupList,omitempty"` // 日志组列表
}
...
type Log_Content struct {
	...
	Key   *string `protobuf:"bytes,1,req,name=key" json:"key,omitempty"`     // 每组字段的 key
	Value *string `protobuf:"bytes,2,req,name=value" json:"value,omitempty"` // 每组字段的 value
}
...
var file_cls_proto_rawDesc = []byte{
	,
}
...
var file_cls_proto_goTypes = []interface{}{
	(*Log)(nil),          // 0: cls.Log
	(*LogTag)(nil),       // 1: cls.LogTag
	(*LogGroup)(nil),     // 2: cls.LogGroup
	(*LogGroupList)(nil), // 3: cls.LogGroupList
	(*Log_Content)(nil),  // 4: cls.Log.Content
}
var file_cls_proto_depIdxs = []int32{
	4, // 0: cls.Log.contents:type_name -> cls.Log.Content
	0, // 1: cls.LogGroup.logs:type_name -> cls.Log
	1, // 2: cls.LogGroup.logTags:type_name -> cls.LogTag
	2, // 3: cls.LogGroupList.logGroupList:type_name -> cls.LogGroup
